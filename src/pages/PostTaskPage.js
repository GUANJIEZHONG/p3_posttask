...
import top from '../components/backgroundimage/top.jpg';
...
/* const theme = createTheme({
  ...
  return (
    ...
    <Box
      ...
      <Typography style={{marginBottom:'10rem', textAlign: 'center' ,color: "#f5f5f5"}} variant="h2" gutterBottom>
...
{/* Step 1 */}
    {activeStep === 0 && (
            <>
            <Box sx={{ p: 2, border: '2px solid purple', borderRadius: '16px', boxShadow: 3,marginBottom:'1rem'}}>
              ...
              <Button onClick={handleClickDate} style={{marginTop:'-2px' }} variant={flag ? "contained" : "outlined"} color={flag ? "success" : "secondary"}>
                I'm flexible
              </Button>
    ...
    {activeStep === 1 && (
          ...
          <Box sx={{display: 'flex',flexDirection: 'row'}}>
            ...
            <Card sx={{marginRight:'1rem', Width: 250, maxHeight: 200, }}>
              ...
              <Button onClick={handleClickInperson} variant={inperson ? "contained" : "outlined"} color={inperson ? "success" : "secondary"} sx={{marginBottom:'1rem'}} size="small">
              select
              </Button>
              </Box>
            ...
            <Card sx={{ Width: 250, maxHeight: 200}} variant="outlined">
              ...
              <Box textAlign='center'>
                <Button onClick={handleClickRemote} variant={remote ?"contained": "outlined"  } color={remote ? "success" : "secondary"} textAlign='center'  size="small">
                select
                </Button>
              </Box>
            </Card>
            ...
            <Typography sx={{marginTop:'2rem', marginBottom:'2rem'}} variant="h4" gutterBottom>
    ...
    {activeStep === 2 && (
            ...
            <Box sx={{ p: 2, border: '2px solid purple', borderRadius: '16px', boxShadow: 3,marginBottom:'1rem'}}>
              ...
              <div className="upload__image-wrapper">
                ...
                <Button sx={{marginBottom:'1rem'}}variant="outlined" onClick={onImageRemoveAll} startIcon={<DeleteIcon />}>
                  Remove all images
                </Button>
                ...
                {imageList.map((image, index) => (
                  ...
                  <div className="image-item__btn-wrapper">
                    <Button sx={{marginTop:'1rem'}} variant="outlined" onClick={() => onImageUpdate(index)}>Replace</Button>
                  &nbsp;
                    <Button sx={{marginTop:'1rem'}} variant="outlined" onClick={() => onImageRemove(index)}>Remove</Button>
                  </div>
                </div>
                ))}
              </div>
